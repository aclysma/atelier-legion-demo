...
pub fn apply_diffs_to_prefab(
    ...
    let (new_world, uuid_to_new_entities) = apply_diffs(&prefab.world, &prefab.prefab_meta.entities, universe, diffs);
...
pub fn apply_diffs_to_cooked_prefab(
    ...
    let (new_world, uuid_to_new_entities) = apply_diffs(&cooked_prefab.world, &cooked_prefab.entities, universe, diffs);
